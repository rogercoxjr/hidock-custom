          ...
          <button
            ...
            className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${
              activeMobilePane === 'left'
                ? 'border-b-2 border-primary text-[var(--accent-soft-text)]'
      ...
      <div className="flex h-full relative">
        ...
        {showRightPanelTablet && (
          <div
            role="region"
            aria-label="AI Assistant"
            className="w-80 border-l border-border overflow-y-auto shadow-lg bg-surface flex-shrink-0 z-10"
          >
            <div className="flex justify-between items-center p-3 border-b border-border bg-surface-sunken">
